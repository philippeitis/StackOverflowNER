...
def loader_so_text(path, merge_tag=True, replace_low_freq_tags=True):
    ...
    if replace_low_freq_tags:
        sorted_entity_list = ["Class", "Class_Name", "Library_Class", "Application", "Library_Variable",
                              "Variable_Name", "Variable", "User_Interface_Element", "Code_Block", "Library_Function",
                              "Function_Name", "Function", "Language", "Library", "Data_Structure", "Data_Type",
                              "File_Type", "File_Name", "Version", "HTML_XML_Tag", "Device", "Operating_System",
                              "User_Name", "Website", "Output_Block", "Error_Name", "Algorithm", "Organization",
                              "Keyboard_IP", "Licence", "Organization"]
